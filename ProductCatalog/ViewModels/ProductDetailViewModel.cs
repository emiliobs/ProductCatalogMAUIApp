...
public partial class ProductDetailViewModel : ObservableObject
{
    ...
    private partial void OnProductIdChanged(int value)
    {
        if (value > 0)
        {
            IsEditMode = true;
    ...
    private async Task SaveAsync()
    {
        ...
        {
            await Shell.Current.DisplayAlert("Error", "Price must be a valid number", "OK");
            return;
        }

        if (!int.TryParse(StockText, out int stock) || stock < 0)
        {
            await Shell.Current.DisplayAlert("Error", "Stock must be a valid number", "OK");
            return;
        }
